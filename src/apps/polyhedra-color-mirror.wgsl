...
// Extended Params struct: the lr/lg/lb and br/bg/bb fields carry per-demo light and bounce tint colors.
// TypeScript getParams() maps to: [lifetime, max_reflections, lr, lg, lb, br, bg, bb].
// time and dt are auto-prepended by paint.mts before those values.
struct Params {
  time: f32,
  dt: f32,
  lifetime: f32,
...
fn fragment_main(vx_out: VertexOut) -> @location(0) vec4<f32> {
  ...
  // Use per-demo color params instead of hardcoded white tints.
